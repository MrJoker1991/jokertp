    ...
    function renderWindow(node, container, options, windowWidth, windowHeight) {
        ...
        return parser.ready.then(function() {
            ...
            if (options.type === "view") {
                ...
                var positionTop = options.positionTop || bounds.top *scale;
                var positionLeft = options.positionLeft || bounds.left *scale;
                console.log(bounds.left * scale)
                canvas = crop(renderer.canvas, {width: bounds.width * scale, height:bounds.height * scale, top: positionTop, left: positionLeft, x: 0, y: 0});
