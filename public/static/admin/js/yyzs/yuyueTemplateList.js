var component = Vue.extend({
    ...
    methods:{
        edit:function (index) {
            ...
            //防引用
            that.config.modalTitle = that.listData[index].content.name;
            ...
            reads.onload = function (e) {
                ...
                qiniu.getUploadToken(function (res) {
                    if (that.config.imgType=='thumbnail'){
                        var _key = 'cdn/yuyue/thumbnail/' + Math.round(new Date().getTime()/1000) + '.png';
                    }else{
                        var _key = 'cdn/yuyue/banner/' + Math.round(new Date().getTime()/1000) + '.png';
                    }
