...
class Wechat
{
    ...
    public function __construct($config)
    {
        ...
        includeExtend("WeChatSDK.Utils.Prpcrypt");
    }
    ...
    private function checkSignature() 
    {
        if ($this->signature !== false && $this->timestamp !== false && $this->nonce !== false) {
            ...
            if ($tmp_signature === false) {
                debug_log('Validate signature error.');
        ...
        if ($this->echostr === false && $this->checkSignature()) {
            ...
            if (!empty($xml_input)) {
                ...
                if ($this->encrypt_type == 'aes') {
                    ...
                    if ($xml_input1 === false) {
                        debug_log('Decode Message Error.');
                        exit();
                    }
